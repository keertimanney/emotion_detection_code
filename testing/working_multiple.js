...
let limit1 = Math.ceil(18);
let limit2 = Math.ceil(25);
let limit3 = Math.ceil(15);

let starting_point_1 = new StartingPoint(20*r, 30*r, r, r, limit1);
let starting_point_2 = new StartingPoint(50*r, 25*r, r, r, limit2);
let starting_point_3 = new StartingPoint(75*r, 25*r, r, r, limit3);
...
function draw() {
   ...
   if (current_time - last_updated_time > 2000.0) {
        ...
        let url = 'https://172.20.10.2:4000/get_all_emotions';
...
function iterate(starting_point) {
    ...
    for (i=0; i<l; i++) {
        ...
        let posx = starting_point.a + s*r-ceil(random(1*r))*(r - n);
        let posy = starting_point.b + s*r-ceil(random(1*r))*(r - n);
        ...
        posx = starting_point.a + s*r+ceil(random(1*r))*(r - n);
        posy = starting_point.b + s*r-ceil(random(1*r))*(r - n);
        // rect(posx, posy, movementx, movementy);
        starting_point = fill_colors(starting_point, posx, posy, movementx, movementy, new_color, rectx, recty);
